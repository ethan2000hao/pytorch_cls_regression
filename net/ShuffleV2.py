...
class ShuffleNetV2(nn.Module):
    def __init__(self, input_size=224, n_class=16, model_size='1.0x'):
        ...
        self.globalpool = nn.AvgPool2d(kernel_size=4)  # 默认,padding=1,kernel_size = stride
